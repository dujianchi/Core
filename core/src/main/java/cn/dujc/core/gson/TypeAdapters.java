...
public final class TypeAdapters {
    ...
    public static final TypeAdapterFactory NUMBER_FACTORY = newFactory(Number.class, TypeAdapters.NUMBER);
            ...
            public <T2> TypeAdapter<T2> create(Gson gson, TypeToken<T2> typeToken) {
              ...
              /*throw new JsonSyntaxException("Expected a " + requestedType.getName()
                  + " but was " + result.getClass().getName());*/
                            return (T1) (requestedType.equals(boolean.class) ? false :
                                    requestedType.equals(double.class) ? 0 :
                                            requestedType.equals(float.class) ? 0 :
                                                    requestedType.equals(int.class) ? 0 :
                                                            null);
                        }
                        return result;
                    }
